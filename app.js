...
// Updated application data with all the required modifications
const data = {
  why_public_parks: {
    municipality_benefits: [
      ...
      },
      {
        ...
        description: "شراكة تعد الأولى من نوعها مع القطاع الخاص",
        icon: "🎯"
      }
    ],
    community_benefits: [
      ...
      {
        benefit: "تمكين خطة الصحة المستقبلية",
        description: "تطبيق رؤية المملكة طبيب لكل أسرة",
        icon: "👨‍⚕️"
      },
      {
        benefit: "تسهيل الحصول على الخدمات الطبية",
        description: "مع تطبيق التأمين الطبي لكل مواطن",
        icon: "🛡️"
      }
    ]
  },
  
  // Updated target neighborhoods data - REMOVED Southern Region (الشفا)
  target_neighborhoods: {
    regions: [
      ...
      // REMOVED: Southern Region (المنطقة الجنوبية) with الشفا
    ],
    summary_statistics: {
      total_neighborhoods: 12, // Updated from 13 to 12
      total_population: 1448000, // Updated: 1543000 - 95000 (الشفا) = 1448000
      high_priority: 6,
      medium_priority: 4, // Updated from 5 to 4
      low_priority: 2,
      phase_1: 4,
      phase_2: 5, 
      phase_3: 3 // Updated from 4 to 3
      // REMOVED: coverage_area
    }
  },
  
  // Updated HMG performance - removed capital and revenue data
  hmg_performance: {
    facilities: {
      hospitals_saudi: 15,
      medical_centers_saudi: 9, // Updated from 5 to 9
      international_facilities: 3,
      upcoming_projects: 13, // Added upcoming projects
      total_facilities: 40, // Updated from 23 to 40
      employees: 20000, // Updated: تجاوز 20 ألف موظف
      listing_year: 2020
      // REMOVED: capital and revenue_2021
    },
    growth_metrics: {
...
document.addEventListener('DOMContentLoaded', function() {
  console.log('DOM loaded, initializing updated application with all required changes...');
...
function initializeApplication() {
  ...
  console.log('Application initialized successfully with updated data - 12 neighborhoods, updated employee count, and new community benefits');
}
...
function handleSlideSpecificActions(slideNumber) {
  ...
  setTimeout(() => {
    switch(slideNumber) {
      case 4:
        console.log('Target neighborhoods slide activated - showing 12 neighborhoods (removed الشفا)');
        break;
      case 5:
        console.log('Activating HMG growth chart - updated facilities and employee count');
        if (charts.hmgGrowth) {
...
function initializeCharts() {
  console.log('Initializing charts with updated data...');
...
function createHMGGrowthChart() {
  ...
  try {
    ...
    console.log('HMG growth chart created with updated data');
  } catch (error) {
...
console.log('Updated app.js loaded successfully with all required modifications:');
console.log('- Date changed to October 2025');
console.log('- Partnership text updated');
console.log('- Southern Region (الشفا) removed - now 12 neighborhoods');
console.log('- Coverage area removed');
console.log('- Employee count updated to 20,000+');
console.log('- Capital and revenue data removed');
console.log('- New community benefits added');
console.log('- Phone number updated to 0119995250');